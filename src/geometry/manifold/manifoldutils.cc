...
std::shared_ptr<ManifoldGeometry> hullPoints(const std::vector<glm::vec3>& pts) {
  return std::make_shared<ManifoldGeometry>(std::make_shared<manifold::Manifold>(manifold::Manifold::Hull(pts)));
}
